...
import digital_PCM_epy_block_0 as epy_block_0  # embedded python block
import digital_PCM_epy_block_0_0 as epy_block_0_0  # embedded python block
import sip



class digital_PCM(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "digital_PCM")
        ...
        self.epy_block_0 = epy_block_0.blk(mu=255)
        self.blocks_float_to_char_0 = blocks.float_to_char(1, 16)
        self.blocks_char_to_float_0 = blocks.char_to_float(1, 16)
        self.blocks_add_xx_0 = blocks.add_vff(1)
        self.blocks_add_const_vxx_0 = blocks.add_const_ff(gain)
        ...
        self.connect((self.epy_block_0, 0), (self.blocks_float_to_char_0, 0))
    ...
    def set_gain(self, gain):
        self.gain = gain
        self.blocks_add_const_vxx_0.set_k(self.gain)




def main(top_block_cls=digital_PCM, options=None):
