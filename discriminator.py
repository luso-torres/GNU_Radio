...
class discriminator(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "discriminator")
        ...
        self.blocks_multiply_const_vxx_0 = blocks.multiply_const_ff((180/c.pi))
        self.blocks_divide_xx_0 = blocks.divide_ff(1)
        self.blocks_delay_0 = blocks.delay(gr.sizeof_float*1, 2)
        self.analog_sig_source_x_0 = analog.sig_source_f(samp_rate, analog.GR_COS_WAVE, (freq*3), 1, 0, 0)
        ...
        self.connect((self.analog_sig_source_x_0, 0), (self.blocks_divide_xx_0, 0))
    ...
    def set_freq(self, freq):
        self.freq = freq
        self.analog_sig_source_x_0.set_frequency((self.freq*3))




def main(top_block_cls=discriminator, options=None):
