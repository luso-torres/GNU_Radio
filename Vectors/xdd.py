...
class xdd(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.analog_sig_source_x_1 = analog.sig_source_c(samp_rate, analog.GR_COS_WAVE, .5e3, .5, 0, 0)
        ...
        self.connect((self.analog_sig_source_x_1, 0), (self.qtgui_time_sink_x_0_0_0, 0))
