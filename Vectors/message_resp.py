...
import message_resp_epy_block_0 as epy_block_0  # embedded python block
import message_resp_epy_block_1 as epy_block_1  # embedded python block
import sip
import threading



class message_resp(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Message with Python Blocks", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Message with Python Blocks")
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "message_resp")
        ...
        # Variables
        ##################################################
        self.samp_rate = samp_rate = 3.2e5
        ...
        self.analog_noise_source_x_0 = analog.noise_source_c(analog.GR_GAUSSIAN, 1e0, 0)
...
def main(top_block_cls=message_resp, options=None):
