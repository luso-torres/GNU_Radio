...
class untitled(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self._delay_range = qtgui.Range(200, 300, 5, 256, 200)
        ...
        self._alpha_range = qtgui.Range(0, 1, .1, .5, 200)
        ...
        self.blocks_vector_source_x_0_0 = blocks.vector_source_f([1]*sps + [0]*(1024-sps), True, 1, [])
        self.blocks_vector_source_x_0 = blocks.vector_source_f([1]*sps + [0]*(1024-sps), True, 1, [])
        self.blocks_throttle_0 = blocks.throttle(gr.sizeof_float*1, samp_rate,True)
        self.blocks_delay_1_0 = blocks.delay(gr.sizeof_float*1, 10)
        ...
        self.connect((self.blocks_delay_1, 0), (self.qtgui_time_sink_x_1, 2))
        self.connect((self.blocks_delay_1_0, 0), (self.qtgui_time_sink_x_1, 1))
        self.connect((self.blocks_throttle_0, 0), (self.blocks_delay_0, 0))
        self.connect((self.blocks_vector_source_x_0, 0), (self.blocks_throttle_0, 0))
        self.connect((self.blocks_vector_source_x_0_0, 0), (self.root_raised_cosine_filter_0, 0))
        self.connect((self.root_raised_cosine_filter_0, 0), (self.blocks_delay_1, 0))
        self.connect((self.root_raised_cosine_filter_0, 0), (self.blocks_delay_1_0, 0))
    ...
    def set_taps(self, taps):
        self.taps = taps
        self.root_raised_cosine_filter_0.set_taps(firdes.root_raised_cosine(1, self.samp_rate, (self.samp_rate/self.sps), self.alpha, self.taps))
    ...
    def set_sps(self, sps):
        ...
        self.blocks_vector_source_x_0_0.set_data([1]*self.sps + [0]*(1024-self.sps), [])
        self.root_raised_cosine_filter_0.set_taps(firdes.root_raised_cosine(1, self.samp_rate, (self.samp_rate/self.sps), self.alpha, self.taps))
