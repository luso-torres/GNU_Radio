...
class noise(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.tab.addTab(self.tab_widget_0, 'Without Filter')
        self.tab_widget_1 = Qt.QWidget()
        self.tab_layout_1 = Qt.QBoxLayout(Qt.QBoxLayout.TopToBottom, self.tab_widget_1)
        self.tab_grid_layout_1 = Qt.QGridLayout()
        self.tab_layout_1.addLayout(self.tab_grid_layout_1)
        self.tab.addTab(self.tab_widget_1, 'With Filter')
        ...
        self.connect((self.analog_sig_source_x_1, 0), (self.blocks_add_xx_0_0, 0))
        ...
        self.connect((self.band_pass_filter_0_0, 0), (self.qtgui_freq_sink_x_0_0_0, 0))
        self.connect((self.band_pass_filter_0_0, 0), (self.qtgui_time_sink_x_0_0_0, 0))
        ...
        self.connect((self.blocks_add_xx_0_0, 0), (self.band_pass_filter_0_0, 0))
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.band_pass_filter_0.set_taps(firdes.band_pass(1, self.samp_rate, 500, 1500, 100, window.WIN_HAMMING, 6.76))
        self.band_pass_filter_0_0.set_taps(firdes.band_pass(1, self.samp_rate, 500, 1500, 100, window.WIN_HAMMING, 6.76))
