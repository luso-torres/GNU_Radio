...
import codigo 2_c as c  # embedded python module
import sip



class codigo 2(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "codigo 2")
        ...
        self.blocks_integrate_xx_0 = blocks.integrate_ff(2, 1)
        ...
        self.connect((self.blocks_integrate_xx_0, 0), (self.qtgui_freq_sink_x_0_0, 1))
        self.connect((self.blocks_integrate_xx_0, 0), (self.qtgui_time_sink_x_0_0, 1))
        self.connect((self.blocks_throttle_0_0, 0), (self.blocks_integrate_xx_0, 0))
...
def main(top_block_cls=codigo 2, options=None):
