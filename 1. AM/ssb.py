...
class ssb(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self._f_c_range = qtgui.Range(50e3, 100e3, 2e3, 50e3, 200)
        ...
        self.hilbert_fc_0 = filter.hilbert_fc(65, window.WIN_KAISER, 6.76)
        ...
        self.analog_sig_source_x_0_0_0_0 = analog.sig_source_f(samp_rate, analog.GR_COS_WAVE, f_c, 1, 0, 0)
        self.analog_sig_source_x_0_0_0 = analog.sig_source_f(samp_rate, analog.GR_SIN_WAVE, f_c, 1, 0, 0)
        ...
        self.connect((self.analog_sig_source_x_0_0_0, 0), (self.blocks_float_to_complex_1, 0))
        self.connect((self.analog_sig_source_x_0_0_0_0, 0), (self.blocks_multiply_xx_0, 0))
