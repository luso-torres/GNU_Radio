...
class quad_demodgrc(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        for c in range(1, 2):
            self.top_grid_layout.setColumnStretch(c, 1)
        self._SNR_range = qtgui.Range(0, 100, 1, 10, 50)
        self._SNR_win = qtgui.RangeWidget(self._SNR_range, self.set_SNR, "'SNR'", "dial", float, QtCore.Qt.Horizontal)
        self.top_grid_layout.addWidget(self._SNR_win, 0, 2, 1, 1)
        for r in range(0, 1):
            self.top_grid_layout.setRowStretch(r, 1)
        for c in range(2, 3):
            self.top_grid_layout.setColumnStretch(c, 1)
        ...
        self.blocks_multiply_const_vxx_0 = blocks.multiply_const_ff(SNR)
    ...
    def set_SNR(self, SNR):
        self.SNR = SNR
        self.blocks_multiply_const_vxx_0.set_k(self.SNR)
