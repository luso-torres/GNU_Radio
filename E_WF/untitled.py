...
class untitled(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self._rolloff_range = qtgui.Range(0.1, 1, .05, .8, 200)
        self._rolloff_win = qtgui.RangeWidget(self._rolloff_range, self.set_rolloff, "'rolloff'", "dial", float, QtCore.Qt.Horizontal)
        self.top_layout.addWidget(self._rolloff_win)
        self.uhd_usrp_sink_0 = uhd.usrp_sink(
            ",".join(("addr=192.168.1.35", '')),
            uhd.stream_args(
                cpu_format="fc32",
                args='',
        ...
        self.uhd_usrp_sink_0.set_bandwidth(15e6, 0)
        ...
        self.qtgui_eye_sink_x_0.set_samp_per_symbol(round(samp_rate))
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.qtgui_eye_sink_x_0.set_samp_per_symbol(round(self.samp_rate))
