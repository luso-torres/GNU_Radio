...
class seno(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "seno")
        ...
        self.amp_tx = amp_tx = 10

        ##################################################
        # Blocks
        ##################################################

        self._amp_tx_range = qtgui.Range(0, 30, 1, 10, 200)
        self._amp_tx_win = qtgui.RangeWidget(self._amp_tx_range, self.set_amp_tx, "'amp_tx'", "counter_slider", float, QtCore.Qt.Horizontal)
        self.top_layout.addWidget(self._amp_tx_win)
        self.uhd_usrp_sink_0 = uhd.usrp_sink(
            ",".join(("addr=192.168.1.35", '', "master_clock_rate=200e6")),
            uhd.stream_args(
                cpu_format="fc32",
                args='',
        ...
        self.uhd_usrp_sink_0.set_bandwidth(1500, 0)
        self.uhd_usrp_sink_0.set_gain(amp_tx, 0)
        ...
        self.qtgui_tab_widget_0.addTab(self.qtgui_tab_widget_0_widget_0, 'TX')
        ...
        self.qtgui_tab_widget_0.addTab(self.qtgui_tab_widget_0_widget_1, 'RX')
    ...
    def set_amp_tx(self, amp_tx):
        self.amp_tx = amp_tx
        self.uhd_usrp_sink_0.set_gain(self.amp_tx, 0)
