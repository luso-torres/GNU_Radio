...
import codigo_2_c as c  # embedded python module
import sip



class codigo_2(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "codigo_2")
...
def main(top_block_cls=codigo_2, options=None):
