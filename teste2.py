...
class teste2(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "teste2")
        ...
        self.tab.addTab(self.tab_widget_0, 'Frequência')
        self.tab_widget_1 = Qt.QWidget()
        self.tab_layout_1 = Qt.QBoxLayout(Qt.QBoxLayout.TopToBottom, self.tab_widget_1)
        self.tab_grid_layout_1 = Qt.QGridLayout()
        self.tab_layout_1.addLayout(self.tab_grid_layout_1)
        self.tab.addTab(self.tab_widget_1, 'Tempo')
        ...
        labels = ['Real transformado', 'Complexo transformado', 'Signal 3', 'Signal 4', 'Signal 5',
        ...
        self.connect((self.hilbert_fc_0, 0), (self.qtgui_time_sink_x_0_0, 0))
...
def main(top_block_cls=teste2, options=None):
